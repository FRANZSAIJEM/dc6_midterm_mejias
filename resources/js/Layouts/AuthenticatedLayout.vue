                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="relative inline-flex items-center ml-3">
                                ...
                                <div class="" style="position: fixed; transform: translateY(850px) translateX(325px);">
                                    <button @click="darkTheme = !darkTheme" class="relative m-5
                                    bg-slate-500 rounded-lg shadow-lg p-5 ps-8  hover:bg-slate-400 duration-100
                                    " style="font-size: 30px;">
                                        <div class="w-10 h-5">
                                            ...
                                            >
                                                <i :class="darkTheme ? 'fa-solid fa-lightbulb text-white' : 'fa-regular fa-lightbulb text-yellow-500'"></i>
                                            </div>
                                        </div>
                                    </button>
                                </div>
