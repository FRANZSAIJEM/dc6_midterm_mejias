...
<template>
    <div :class="{ 'filter invert': darkTheme }" class="w-1/2 ml-10">
      <div class=" dark:bg-slate-600 overflow-hidden shadow-sm sm:rounded-lg p-8">
        ...
        <table class="w-full border-collapse">
          <thead>
            <tr :class="{ 'text-gray-700': !darkTheme, 'text-black': darkTheme }"    class="bg-gray-100 dark:bg-slate-600 dark:text-white">
